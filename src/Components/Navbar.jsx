        ...
        <div className='navbar-container'>
            ...
            <div className='menu-icon' onClick={handleClick}>
                ...
                <ul className={click ? 'nav-menu active' : 'nav-menu'}>
                    ...
                    <li className='nav-item'>
                        <a href='/devportfolio/Markel_Bradford_Resume.pdf' className='nav-links-mobile' onClick={closeMobileMenu} target="_blank" rel='noreferrer'> 
                        Resume
                        </a>
                    </li>

                    <li>
                        <a href='/devportfolio/Markel_Bradford_Resume.pdf' className='resume-button' target='_blank'>Resume</a>
                    </li>
                    <li className='nav-item'>
                        <Toggle />
                    </li>
